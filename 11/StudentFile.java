import java.awt.*;import java.awt.event.*;import java.io.FileWriter;
class LabelTFPanel extends Panel{
	Label l1 = new Label();TextField tf1 = new TextField();
...
class LabelChoicePanel extends Panel{
	Label l1 = new Label();Choice c1 = new Choice();
	LabelChoicePanel(String lbl, String[] Choice){
		super();setLayout(null);
		setLayout(new FlowLayout(FlowLayout.CENTER));l1.setText(lbl);
