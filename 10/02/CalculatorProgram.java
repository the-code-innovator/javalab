...
class Calculator extends Frame implements ActionListener{
	...
	Panel p1 = new Panel();
	Panel cont = new Panel(new BorderLayout(50,50));
	...
	Calculator(){
		...
		//adding it to Frame
		cont.add(tf1,BorderLayout.NORTH);
	...
	public void actionPerformed(ActionEvent e){
		...
		switch(e.getActionCommand()){
			...
			case "<-":
			Tstr = tf1.getText().substring(0,tf1.getText().length()-1);
			tf1.setText(Tstr);
			break;
...
// <applet code="CalculatorProgram" width=0 height=0></applet>
